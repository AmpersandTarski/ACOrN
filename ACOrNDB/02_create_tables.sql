...
CREATE DATABASE IF NOT EXISTS `ampersand_ACOrN` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ampersand_ACOrN`;
...
CREATE TABLE `Item` (
  ...
  `loadedInACOrNOk` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `context` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
ALTER TABLE `Item`
  ...
  ADD KEY `Item_loadedInACOrNOk` (`loadedInACOrNOk`),
