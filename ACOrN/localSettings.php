...
AngularApp::addJS('extensions/AceEditor/ACOrN-ace.js'); // Adds Ace editor to ACOrN application
...
require_once(__DIR__ . '/extensions/OAuthLogin/OAuthLogin.php');
	Config::set('redirectAfterLogin', 'OAuthLogin', 'http://example.com/AmpersandPrototypes/ACOrN/#/My_32_Account');
	Config::set('identityProviders', 'OAuthLogin',
	                   ['linkedin' => 
								...
								,'redirectUrl' => 'http://example.com/AmpersandPrototypes/ACOrN/api/v1/oauthlogin/callback/linkedin'
			   ...
			   ,'github' =>
                                ...
                                ,'redirectUrl' => 'http://example.com/AmpersandPrototypes/ACOrN/api/v1/oauthlogin/callback/github'
