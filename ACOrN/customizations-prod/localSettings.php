 ...
 * SERVER settings
 *************************************************************************************************/
Config::set('serverURL', 'global', 'http://ACOrN.cs.ou.nl/ACOrN'); // defaults to http://localhost/<ampersand context name>
...
Config::set('dbName', 'mysqlDatabase', '{SQLDB}');       // typically: '' or 'ampersand_ACOrN'
...
require_once(__DIR__ . '/extensions/OAuthLogin/OAuthLogin.php');
    Config::set('redirectAfterLogin', 'OAuthLogin', 'http://ACOrN.cs.ou.nl/ACOrN/#/My_32_Account'); // path 'redirect-after-login' triggers frontend to route back to page where status 401 was raised.
    Config::set('redirectAfterLoginFailure', 'OAuthLogin', 'http://ACOrN.cs.ou.nl/ACOrN/#/');
    Config::set(
        ...
        ['linkedin' => 
            ...
            ,'redirectUrl' => 'http://ACOrN.cs.ou.nl/ACOrN/api/v1/oauthlogin/callback/linkedin'
        ...
        ,'github' =>
            ...
            ,'redirectUrl' => 'http://ACOrN.cs.ou.nl/ACOrN/api/v1/oauthlogin/callback/github'
